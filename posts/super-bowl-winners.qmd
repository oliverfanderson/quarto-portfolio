...
description: "An exploration of the `gt` package in R. Data from kaggle.com."
date: "2023-02-13"
...
In celebration of the 2023 Super Bowl, I wanted explore the features of the `gt` R package by creating a table of all the teams that had won the Super Bowl since Super Bowl I.
