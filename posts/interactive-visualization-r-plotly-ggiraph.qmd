...
This project demonstrates how to create interactive plots in R using the [`plotly`](https://plotly.com/r/ "Plotly - R Package"){target="blank"} and [`ggiraph`](https://davidgohel.github.io/ggiraph/ "Ggiraph - R Package"){target="blank"} packages. The dataset comes from [Kaggle](https://www.kaggle.com/datasets/thedevastator/annual-percent-of-possible-sunshine-by-us-city "Annual Percent of Possible Sunshine by US City - Kaggle"){target="blank"}, which reports the percentage of possible sunshine across major U.S. cities.
