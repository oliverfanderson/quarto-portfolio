...
This project demonstrates how to create interactive plots in R using the [`plotly`](https://plotly.com/r/) and [`ggiraph`](https://davidgohel.github.io/ggiraph/) packages. The dataset comes from [Kaggle](https://www.kaggle.com/datasets/thedevastator/annual-percent-of-possible-sunshine-by-us-city), which reports the percentage of possible sunshine across major U.S. cities.  
