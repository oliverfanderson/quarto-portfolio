...
The project was developed at [Reed College](https://reed.edu/ "Reed College Homepage"){target="_blank"} under the guidance of **Dr. Anna Ritz**, with collaboration from **Altaf Barelvi**. You can try ProteinWeaver on the [official website](https://proteinweaver.reedcompbio.org/ "ProteinWeaver - Home"){target="_blank"} or view the source code on [GitHub](https://github.com/Reed-CompBio/protein-weaver "ProteinWeaver - GitHub Repository").
...
![Fig. 1 – Screenshot of an example ProteinWeaver query.](images/PW-screenshot.png "Screenshot of ProteinWeaver interface")
...
This work resulted in a [**publication**](/publications.qmd "Publications - Oliver F. Anderson, MS") and a **poster presentation**:\
- Presented at the *RSGDREAM 2023* [conference](https://www.iscb.org/rsgdream2023 "RSGDREAM 2023 Conference"){target="_blank"}\
- Published in: 👉 [*PLOS ONE*](https://doi.org/10.1371/journal.pone.0331280 "ProteinWeaver: A webtool to visualize ontology-annotated protein networks"){target="_blank"}
