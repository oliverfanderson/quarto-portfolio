...
The workflow combined API scraping, SQL database design, and deployment in a [Docker](https://www.docker.com/) container.

1.  **Exchange Rates**: Scraped daily USD-based exchange rates from [exchangerate.host](https://api.exchangerate.host/latest/?base=USD).
2.  **Database Deployment**: Ran the SQL database inside a Docker container and hosted it on [Railway.app](https://railway.app/) for remote access.
...
-   **Additional Data Sources**:
    -   [Worldometers](https://www.worldometers.info/gdp/gdp-by-country/) GDP growth data.
    -   [iban.com](https://www.iban.com/currency-codes) country names and currency codes.
