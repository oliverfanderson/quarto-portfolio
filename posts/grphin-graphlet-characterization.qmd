...
You can access the code on [GitHub](https://github.com/Reed-CompBio/grphin "GRPhIN - GitHub Repository"){target="blank"} or read the paper in *Bioinformatics Advances* [here](https://doi.org/10.1093/bioadv/vbaf176 "GRPhIN: Graphlet characterization of regulatory and physical interaction networks"){target="blank"}. GRPhIN was selected as a full-length talk at **GLBIO 2025**.
...
- Presented at the GLBIO 2025 [conference](https://www.iscb.org/glbio2025/home "GLBIO 2025 - Home"){target="blank"}\
- Published in: 👉[Bioinformatics Advances](https://doi.org/10.1093/bioadv/vbaf176 "GRPhIN: Graphlet characterization of regulatory and physical interaction networks"){target="blank"}
...
::: faq-answer
GRPhIN is open source on [GitHub](https://github.com/Reed-CompBio/grphin "GRPhIN - GitHub Repository"){target="blank"}. A detailed description is available in the [publication](https://doi.org/10.1093/bioadv/vbaf176 "GRPhIN: Graphlet characterization of regulatory and physical interaction networks"){target="blank"}.
:::
