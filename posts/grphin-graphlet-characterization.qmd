...
You can access the code on [GitHub](https://github.com/Reed-CompBio/grphin) or read the paper in *Bioinformatics Advances* [here](https://doi.org/10.1093/bioadv/vbaf176). GRPhIN was selected as a full-length talk at **GLBIO 2025**.
...
![Graphlet and orbit labeling illustration](images/GraphletsSortingDrawing.png)
...
GRPhIN provides:
- Functional insight into proteins beyond a single network type.
- The ability to compare structural motifs across organisms or experimental conditions.
- A foundation for testing hypotheses about protein function in mixed interaction settings.
...
- Presented at the GLBIO 2025 [conference](https://www.iscb.org/glbio2025/home)\
- Published in:
  👉[Bioinformatics Advances](https://doi.org/10.1093/bioadv/vbaf176)

## FAQ: Using GRPhIN
:::::::: faqs-container

<details class="faq"> <summary>[What is a graphlet?]{.faq-question}</summary>
...
</details> <details class="faq"> <summary>[Why combine regulatory and physical interactions?]{.faq-question}</summary>
...
</details> <details class="faq"> <summary>[What are orbits?]{.faq-question}</summary>
...
</details> <details class="faq"> <summary>[Where can I access GRPhIN?]{.faq-question}</summary>

::: faq-answer
GRPhIN is open source on [GitHub](https://github.com/Reed-CompBio/grphin). A detailed description is available in the [publication](https://doi.org/10.1093/bioadv/vbaf176).
:::
  ...
  "mentions": [
    {
      ...
      "isPreprint": "true",
      "url": "https://www.biorxiv.org/content/10.1101/2025.02.19.639099v1"
    }
  ]
}
</script>
