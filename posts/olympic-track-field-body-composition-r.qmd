...
These data align with my anectodal observations of track and field events. The trends indicate that specific events attract athletes with distinct body sizes, likely due to inherent advantages associated with their builds. This project has been a fun way to combine my passion for track and field with data science techniques. [Please reach out](/contact.qmd) if you have any project ideas or would like to collaborate.
...
::: faq-answer
The data was published as part of the [TidyTuesday project](https://github.com/rfordatascience/tidytuesday/blob/main/data/2021/2021-07-27/readme.md) (July 27, 2021) and includes Olympic athletes across many sports and years.
:::
